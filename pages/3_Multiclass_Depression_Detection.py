...
def interpret_local_ig_detailed(merged_words, merged_attrs, class_name, top_k=5):
    ...
    explanation = (
        ...
        f"*Note: Contribution scores are relative and do not represent probabilities or clinical diagnoses.*"
    )
...
uploaded_file = st.file_uploader(
    "Upload a file with social media textual data (CSV or Excel format)", 
    type=["csv", "xlsx"],
    help="Upload a CSV or Excel file with social media data."
)
